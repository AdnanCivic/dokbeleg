    ...
    <div class="container" id="app">
        <div class="navbar navbar-expand-md">
            ...
            <div class="btn-group" style="margin-right: 20px; background-color:#6c757d">
                ...
                <router-link class="btn btn-success" :to="{name: 'GruppeCreate'}" style="margin-left: 10px">Gruppe erstellen</router-link>
            </div>
            <div class="btn-group" style="margin-right: 20px; background-color:#6c757d">
                <router-link class="btn btn-primary" :to="{name: 'AlleDokumente'}" exact>Index</router-link>
                <router-link class="btn btn-success" :to="{name: 'DokumentCreate'}" style="margin-left: 10px">Dokument erstellen</router-link>
            </div>
        </div>
        <div class="container">
